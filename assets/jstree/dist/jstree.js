 ...
 */
	...
	$.jstree = {
		...
		defaults : {
			/**
			 * configure which layouts will be active on an instance. Should be an array of strings, where each element is a plugin name. The default is `[]`
			 * @name $.jstree.defaults.plugins
			 */
			plugins : []
		},
		/**
		 * stores all loaded jstree layouts (used internally)
		 * @name $.jstree.plugins
		 */
		plugins : {},
	 ...
	 *	$('#tree2').jstree({ layouts : [] }); // create an instance with some options
 ...
 */
	...
	// $.jstree.defaults.layouts.push("checkbox");
 ...
 */
	...
	// $.jstree.defaults.layouts.push("contextmenu");
 ...
 */
	...
	// $.jstree.defaults.layouts.push("dnd");
 ...
 */
	...
	// $.jstree.defaults.layouts.push("search");
 ...
 */
	...
	// $.jstree.defaults.layouts.push("sort");
 ...
 */
	...
	// $.jstree.defaults.layouts.push("state");
 ...
 */
	...
	// $.jstree.defaults.layouts.push("types");
 ...
 */
	...
	// $.jstree.defaults.layouts.push("unique");
 ...
 */
	...
	// $.jstree.defaults.layouts.push("wholerow");

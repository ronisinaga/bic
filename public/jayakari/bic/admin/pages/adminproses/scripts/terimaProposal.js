        ...
        toastr.options = {
            ...
            "onHidden": function () {
                if (proposal.config.valid) {
                    //alert('Muncul');
                    proposal.redirectToPage(host+'/admin/adminproses/proposal/diterima');
                }
            },
            "showDuration": "300",
            "hideDuration": "1000",
            ...
            $.ajax({
                ...
                success: function (response){
                    if (response.status=="success"){
                        proposal.config.valid = true;
                        toastr["success"]('Sukses kirim pesan ke inovator','Sukses');

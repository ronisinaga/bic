...
var testimonial = {
    ...
    valid: function(){
        ...
        if (testimonial.config.editor.getData() == ""){
            ...
            toastr['error']('Gambar untuk testimonial harus ada','Error');
            testimonial.config.valid = false;
        }
    ...
    uploadGambar: function(){
        if (testimonial.valid()){
            ...
            $.ajax({
                method: 'POST',
                url: host+'/admin/testimonial/create',
                ...
                success: function (response){
                    if (response.status == "success"){
                        testimonial.config.valid = true;
                        toastr["success"]('Berhasil upload testimonial','Success');
                    }else{
                        testimonial.config.valid = false;
                        toastr["error"]('Gagal upload testimonial','Error');
                    }
                },

...
var dictionary = {
    ...
    setup: function(){
        toastr.options = {
            ...
            "onclick": null,
            "onHidden": function() {
                //location.href = host+'/admin/dictionary';
    ...
    save: function(json){
        $.ajax({
            method: 'POST',
            url: host+'/admin/dictionary/'+$('#id').val()+'/delete',
            data: {
                data: json
            },
            dataType: "json",
            ...
            success: function (response){
                ...
                if (response.status == 'success'){
                    ...
                    toastr['success']("Sistem berhasil hapus data dictionary dengan nilai "+$('#name').val(),"Success");
                }
            },

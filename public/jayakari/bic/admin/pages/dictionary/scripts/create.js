...
var dictionary = {
    ...
    save: function(json){
        $.ajax({
            method: 'POST',
            url: host+'/admin/dictionary/create',
            data: {
                data: json
            },
            dataType: "json",
...
$('#btnSimpan').on('click',function(){
    ...
    var json = "";
    json= '{"sender":"bic","id_kategori_dictionary":"'+value[0]+'","value":"'+$("#value").val()+'","public_path":"","keterangan":"'+$("#keterangan").val()+'"}';
...
$('#btnSimpanLinkText').on('click',function(){
    ...
    var value = $("#selKategori").val().split('-');
    var json = "";
    json = '{"sender":"bic","id_kategori_dictionary":"'+value[0]+'","value":"'+$("#valueURL").val()+'","public_path":"'+$("#url").val()+'","keterangan":"'+$("#keteranganLinkText").val()+'"}';
    dictionary.save(json);
});
...
$('#btnSimpanAngka').on('click',function(){
    ...
    if (isNaN($('#valueAngka').val())){
        ...
        var value = $("#selKategori").val().split('-');
        var json = "";
        json = '{"sender":"bic","id_kategori_dictionary":"'+value[0]+'","value":"'+$("#valueAngka").val()+'","public_path":"","keterangan":"'+$("#keteranganAngka").val()+'"}';
        dictionary.save(json);
    }
});

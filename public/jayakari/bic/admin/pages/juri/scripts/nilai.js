...
var nilai = {
    ...
    setup: function(){
        ...
        toastr.options = {
            ...
            "onclick": null,
            "onHidden": function() {
                if (nilai.config.valid){
                    nilai.redirectToPage(host+'/admin/juri/proposal/belumnilai');
                }
            },
            "showDuration": "300",
            "hideDuration": "1000",
    ...
    save: function(json){
        $.ajax({
            method: 'POST',
            url: host+'/admin/juri/proposal/'+$('#id').val()+'/nilai',
            data: {
                data: json
            },
            dataType: "json",
...
$('#new').on('click',function(){
    nilai.redirectToPage(host+'/admin/nilai/create');
});
...
$('#btnSimpan').on('click',function(){
    //nilai.redirectToPage(host+'/admin/nilai');
    var TNO = "0";
    var TNRU = "0";
    var TNDT = "0";
    var TNT = "0";

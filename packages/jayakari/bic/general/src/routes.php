...
Route::get('/inovator/video','jayakari\bic\general\Controllers\VideoController@video')->name('inovator.video');
Route::get('/inovator/video/{title}','jayakari\bic\general\Controllers\VideoController@videoDetail')->name('inovator.video.detail');

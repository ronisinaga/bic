    ...
    <div class="main">
        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active">Message Admin Proses</li>
            </ul>
            ...
            <div class="row margin-bottom-40">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <img src="<?php echo env('APP_URL'); ?>/public/storage/manual/adminproses/admin_proses_message.png"/><br><br>
                    ...
                    <ul>
                        <li>
                            ...
                            <img src="<?php echo env('APP_URL'); ?>/public/storage/manual/adminproses/admin_proses_message_1.png"/><br><br>
                            <p style="text-align: justify;font-size: 14px;">Pesan-pesan dalam Inbox berisikan pesan-pesan yang dikirim oleh reviewer kepada admin proses ketika reviewer menyatakan proposal
                                sudah dinyatakan lengkap dan layak untuk di review isinya. Setelah di klik maka akan muncul tampilan seperti pada gambar dibawah ini</p>
                        ...
                        <li>
                            ...
                            <img src="<?php echo env('APP_URL'); ?>/public/storage/manual/reviewer/reviewer_message_2.png"/><br><br>
                            <p style="text-align: justify;font-size: 14px;">Pesan-pesan dalam sent message berisikan pesan-pesan yang dikirim oleh reviewer kepada inovator yang merupakan tanggapan yang diberikan oleh reviewer

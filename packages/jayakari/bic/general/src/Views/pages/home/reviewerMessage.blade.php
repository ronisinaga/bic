    ...
    <div class="main">
        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active">Message Reviewer</li>
            </ul>
            ...
            <div class="row margin-bottom-40">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <img src="<?php echo env('APP_URL'); ?>/public/storage/manual/reviewer/reviewer_message.png"/><br><br>
                    ...
                    <ul>
                        <li>
                            ...
                            <img src="<?php echo env('APP_URL'); ?>/public/storage/manual/reviewer/reviewer_message_1.png"/><br><br>
                            <p style="text-align: justify;font-size: 14px;">Pesan-pesan dalam Inbox berisikan pesan-pesan yang dikirim oleh inovator kepada reviewer ketika inovator meminta review kepada reviewer.

                                ...
                                <div class="row">
                                    <div class="col-md-3 col-xs-12 col-12" style="margin-top: 10px;">
                                        @if (count($latestNews[$i]->image) > 0)
                                            <a href="{{env('APP_URL')}}/general/berita/utama/{{urlencode($latestNews[$i]->judul)}}"><img src="<?php echo env('APP_URL'); ?>/public/storage/news/{{$latestNews[$i]->image[0]->file300x300}}" height="250px" alt="{{$latestNews[$i]->judul}}"></a><br>
                                        @else
                                        ...
                                        @else
                                            <span class="img-text">{{$title}}</span>
                                        @endif<br>
                                        <a href="{{env('APP_URL')}}/general/berita/utama/{{urlencode($latestNews[$i]->judul)}}" class="btn btn-primary">Read More <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                    @if(($i+1) < $num)
                                        <div class="col-md-3 col-xs-12 col-12" style="margin-top: 10px;">
                                            @if (count($latestNews[$i+1]->image) > 0)
                                                <a href="{{env('APP_URL')}}/general/berita/utama/{{urlencode($latestNews[$i+1]->judul)}}"><img src="<?php echo env('APP_URL'); ?>/public/storage/news/{{$latestNews[$i+1]->image[0]->file300x300}}" height="250px" alt="{{$latestNews[$i+1]->judul}}"></a><br>
                                            @else
                                                <img src="<?php echo env('APP_URL'); ?>/public/storage/no_image.jpg" height="250px" alt="Owl Image"><br>
                                            @endif
                                            ...
                                            @else
                                                <span class="img-text">{{$title}}</span>
                                            @endif<br>
                                            <a href="{{env('APP_URL')}}/general/berita/utama/{{urlencode($latestNews[$i+1]->judul)}}" class="btn btn-primary">Read More <i class="fa fa-angle-double-right"></i> </a>
                                        </div>
                                    @endif
                                    @if(($i+2) < $num)
                                        <div class="col-md-3 col-xs-12 col-12" style="margin-top: 10px;">
                                            @if (count($latestNews[$i+2]->image) > 0)
                                                <a href="{{env('APP_URL')}}/general/berita/utama/{{urlencode($latestNews[$i+2]->judul)}}"><img src="<?php echo env('APP_URL'); ?>/public/storage/news/{{$latestNews[$i+2]->image[0]->file300x300}}" height="250px" alt="{{$latestNews[$i+2]->judul}}"></a><br>
                                            @else
                                                <img src="<?php echo env('APP_URL'); ?>/public/storage/no_image.jpg" height="250px" alt="Owl Image"><br>
                                            @endif
                                            ...
                                            @else
                                                <span class="img-text">{{$title}}</span>
                                            @endif<br>
                                            <a href="{{env('APP_URL')}}/general/berita/utama/{{urlencode($latestNews[$i+2]->judul)}}" class="btn btn-primary">Read More <i class="fa fa-angle-double-right"></i></a><br>
                                    ...
                                    @if(($i+3) < $num)
                                        <div class="col-md-3 col-xs-12 col-12" style="margin-top: 10px;">
                                            @if (count($latestNews[$i+3]->image) > 0)
                                                <a href="{{env('APP_URL')}}/general/berita/utama/{{urlencode($latestNews[$i+3]->judul)}}"><img src="<?php echo env('APP_URL'); ?>/public/storage/news/{{$latestNews[$i+3]->image[0]->file300x300}}" height="250px" alt="{{$latestNews[$i+3]->judul}}"></a><br>
                                            @else
                                                <img src="<?php echo env('APP_URL'); ?>/public/storage/no_image.jpg" height="250px" alt="Owl Image"><br>
                                            @endif
                                            ...
                                            @else
                                                <span class="img-text">{{$title}}</span>
                                            @endif<br>
                                            <a href="{{env('APP_URL')}}/general/berita/utama/{{urlencode($latestNews[$i+3]->judul)}}" class="btn btn-primary">Read More <i class="fa fa-angle-double-right"></i></a>

...
@section('content')
    ...
    <div class="main">
         <div class="container">
             <div class="row">
                 <div class="col-md-4">
                     <input type="hidden" id="judul" name="judul" value="{{$currbuku->judul}}" class="form-control">
                     ...
                     <table class="table table-striped table-bordered table-hover" id="sample_1">
                         ...
                         for($i=0;$i<$num;$i=$i+2){
                             ...
                             if ($num > $i+1){
                                 ...
                                 echo '<div class="col-md-12">';
                                 $strurl = $isibuku[$i+1]->judul_singkat;
                                 $strurl = str_replace('+','~',$strurl);
                                 $url = urlencode($strurl);
                                 echo '<h4><a href="'.env('APP_URL').'/general/view/'.$url.'">'.$isibuku[$i+1]->judul_singkat.'</a></h4>';
                                 echo '<h4><i><a href="'.env('APP_URL').'/general/view/'.$url.'">'.$isibuku[$i+1]->short_title.'</a></i></h4><hr>';

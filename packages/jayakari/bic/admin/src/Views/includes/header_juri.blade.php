                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle" src="/bic_new/public/jayakari/bic/admin/layouts/img/alihaliman_small.jpg" />
                            <span class="username username-hide-on-mobile"> Dewan Juri </span>
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <a href="/bic_new/admin/users/profileUserJuri">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item  ">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  ">
                            <a href="/bic_new/admin/users/profileUserJuri" class="nav-link ">
                                <span class="title">Profile</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="/bic_new/admin/home/ubahPasswordJuri" class="nav-link ">
                ...
                <li class="nav-item  ">
                    <a href="/bic_new/admin/proposals/listProposalsBelumNilai" class="nav-link nav-toggle">
                        <i class="icon-puzzle"></i>
                        <span class="title">Proposal Belum Dinilai</span>
                        <span class="arrow"></span>
                    </a>
                </li>
                <li class="nav-item  ">
                    <a href="/bic_new/admin/proposals/listProposalsSudahNilai" class="nav-link nav-toggle">
                        <i class="icon-puzzle"></i>
                        <span class="title">Proposal Sudah Dinilai</span>
                        <span class="arrow"></span>
                    </a>
                </li>
            </ul>

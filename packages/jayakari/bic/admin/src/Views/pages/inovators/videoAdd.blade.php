    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Video Inovator
                <small>Tambah Video Inovator</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Tambah Video Inovator</span>
                    </li>
                </ul>
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Tambah Video Inovator</span>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <select class="form-control" id="selInnovator" name="selInnovator">
                                            ...
                                            @foreach($innovator as $ino)
                                                <option value="{{$ino->id}}">{{$ino->fullname}}</option>
                                            @endforeach
                                        </select>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/inovators/scripts/videoInovatorAdd.js" type="text/javascript"></script>
@stop

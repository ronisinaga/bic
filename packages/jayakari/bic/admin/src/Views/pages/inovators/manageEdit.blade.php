                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <input type="hidden" id="id" name="id" value="{{$explanation->id}}"/>
                            <form role="form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <select class="form-control" id="selProposalType" name="selProposalType">
                                                        ...
                                                        <option value="laboratorium" <?php $selected = $explanation->proposal_type == "laboratorium"?"selected":"";echo $selected; ?>>Skala Laboraorium</option>
                                                        <option value="lapangan" <?php $selected = $explanation->proposal_type == "lapangan"?"selected":"";echo $selected; ?>>Uji Lapangan</option>
                                                        <option value="ekonomi" <?php $selected = $explanation->proposal_type == "ekonomi"?"selected":"";echo $selected; ?>>Kelayakan Ekonomi/Siap Diterapkan</option>
                                                        <option value="komersil" <?php $selected = $explanation->proposal_type == "komersil"?"selected":"";echo $selected; ?>>Telah Dikomersialkan</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="divData" name="divData" style="display: block">
                                        <div class="portlet box blue">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <textarea class="ckeditor form-control" id="highlight" name="highlight" rows="6"><?php echo $explanation->highlight; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="portlet box yellow">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <input type="text" id="title" name="title" value="{{$explanation->judul}}" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="portlet box blue">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <textarea class="ckeditor form-control" id="abstrak" name="abstrak" rows="6"><?php echo $explanation->abstrak; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="portlet box green">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <textarea class="ckeditor form-control" id="deskripsi" name="deskripsi" rows="6"><?php echo $explanation->deskripsi; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="portlet box purple">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <textarea class="ckeditor form-control" id="teknologi" name="teknologi" rows="6"><?php echo $explanation->keunggulan_teknologi; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="portlet box yellow">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <textarea class="ckeditor form-control" id="aplikasi" name="aplikasi" rows="6"><?php echo $explanation->potensi_aplikasi; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" id="update" name="update"><i class="fa fa-save"></i> update</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/inovators/scripts/manageEdit.js" type="text/javascript"></script>

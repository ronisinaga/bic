                            ...
                            <form role="form">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <td><?php echo $proposalJuri[0]->nilai_1;?></td>
                                        <td><?php echo $proposalJuri[0]->nilai_2;?></td>
                                        <td><?php echo $proposalJuri[0]->nilai_3;?></td>
                                        <td><?php echo $proposalJuri[0]->nilai_4;?></td>
                                        <td><?php echo $proposalJuri[0]->nilai_5;?></td>
                                        <td><?php echo $proposalJuri[0]->nilai_6;?></td>
                                        <td><?php echo $proposalJuri[0]->nilai_7;?></td>
                                        <td><?php echo $proposalJuri[0]->nilai_8;?></td>
                                        <td><?php
                                ...
                                <div>
                                    <h3>Alasan Pemberian Nilai</h3><hr>
                                    <?php
                                    if (count($proposalJuri) > 0){
                                        echo $proposalJuri[0]->alasan;
                                    }
                                    ?>

                                </div><hr>
                                <h3>Detail Proposal {{$proposal->judul}}</h3>

...
@section('content')
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title"> Manajemen Proposal History Nilai
                <small>Daftar proposal yang sudah selesai</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="icon-diamond"></i>
                        <a href="javascript:;">Manajemen Penilaian Juri</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span>Daftar penilaian juri berdasarkan topik</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Proposal sudah selesai Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar penilaian juri berdasarkan topik</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($topik as $item)
                                    <tr>
                                        ...
                                        <td><a href="<?php echo env('APP_URL'); ?>/admin/juri/{{$item->id}}/topiknilai">{{$item->topik}}</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>

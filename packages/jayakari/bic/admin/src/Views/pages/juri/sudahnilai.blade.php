...
@section('content')
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title"> Manajemen Proposal Sudah Nilai
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Daftar proposal yang sudah dinilai</span>
                    </li>
                </ul>
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Proposal yang sudah dinilai</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($proposal as $item)
                                    <tr>
                                        ...
                                        <td><a href="<?php echo env('APP_URL'); ?>/admin/juri/proposal/{{$item->id}}/lihatnilai">{{$item->proposal->judul}}</a></td>
                                        <td>
                                            <?php
                                                if ($item->topik->batch->is_finished <> 2){
                                            ?>
                                            <a href="<?php echo env('APP_URL'); ?>/admin/juri/proposal/{{$item->id}}/revisinilai" class="btn purple">

        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Proposal Disimpan</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Proposal Disimpan Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Proposal Disimpan</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($proposal as $item)
                                    <tr>
                                        ...
                                        <td><a href='<?php echo env('APP_URL'); ?>/admin/reviewer/proposal/{{$item->id}}/7/masuk'>{{$item->judul}}</a></td>
                                        <td>{{$item->statusProposal->status}}</td>
                                        <td><button type="button" class="btn blue" id="ubah" name="ubah"><i class="fa fa-floppy-o"></i> Ubah Status</button></td>
                                    </tr>
                                    <?php $index++ ?>
                                @endforeach
                                </tbody>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/proposals/scripts/disimpanProposal.js" type="text/javascript"></script>

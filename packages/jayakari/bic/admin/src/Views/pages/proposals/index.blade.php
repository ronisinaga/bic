            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Proposal Masuk Content
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="new" name="new" class="btn sbold green"> Buat Proposal Baru
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1" name="sample_1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if (($item->statusProposal->status == 'BARU')){
                                                echo '<a href="'.env('APP_URL').'/admin/inovator/proposal/'.$item->id.'/edit" class="btn blue"><i class="fa fa-pencil"></i> Edit Judul </a>';
                                                echo '<a href="'.env('APP_URL').'/admin/inovator/proposal/'.$item->id.'/lengkapi" class="btn red"><i class="fa fa-adjust"></i> Lengkapi </a>';
                                            }else if ($item->statusProposal->status == 'REVISI'){
                                                echo '<a href="'.env('APP_URL').'/admin/inovator/proposal/'.$item->id.'/1/edit" class="btn purple"><i class="fa fa-unlock"></i> REVISI </a>';
                                                echo '<a href="'.env('APP_URL').'/admin/inovator/proposal/'.$item->id.'/lengkapi" class="btn red"><i class="fa fa-adjust"></i> Lengkapi </a>';
                                            } else if ($item->statusProposal->status == 'BATAL'){
                                                echo '<button class="btn green" name="change" id="change"><i class="fa fa-edit"></i> AKTIFKAN </button>';
                                            }
                                        ?>
                                    </td>
                                </tr>

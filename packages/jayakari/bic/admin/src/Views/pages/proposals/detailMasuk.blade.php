                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <?php
                                                    if (count($proposal[0]->development) > 0){
                                                    ?>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="tblTeknologiLevel3" name="tblTeknologiLevel3">
                                                        ...
                                                        <?php
                                                        $index = 1;
                                                        $num = count($proposal[0]->kunciTeknologi);
                                                        ?>
                                                        @for($i=0;$i<$num;$i++)
                                                            <tr>
                                                                <td>{{$index}}</td>
                                                                <td>
                                                                    <?php
                                                                        if (count($kunciTeknologiLevel1) > 0){
                                                                            echo $kunciTeknologiLevel1[$i]->kata_kunci;
                                                                        }else{
                                                                            echo '-';
                                                                        }
                                                                    ?>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                    if (count($kunciTeknologiLevel2) > 0){
                                                                        echo $kunciTeknologiLevel2[$i]->kata_kunci;
                                                                    }else{
                                                                        echo '-';
                                                                    }
                                                                    ?>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                        if ($proposal[0]->kunciTeknologi[$i]->id_kata_kunci == 0){
                                                                            echo '';
                                                                        }else{
                                                                            echo $proposal[0]->kunciTeknologi[$i]->kataKunciTeknologi->kata_kunci;
                                                                        }
                                                                    ?>
                                                                </td>
                                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="tblTeknologiLevel3" name="tblTeknologiLevel3">
                                                        ...
                                                        <?php
                                                        $index = 1;
                                                        $num = count($proposal[0]->kunciAplikasi);
                                                        ?>
                                                        @for($i=0;$i<$num;$i++)
                                                            <tr>
                                                                <td>{{$index}}</td>
                                                                <td>{{$kunciAplikasiLevel1[$i]->kata_kunci}}</td>
                                                                <td>{{$kunciAplikasiLevel2[$i]->kata_kunci}}</td>
                                                                <td>
                                                                    <?php
                                                                    if ($proposal[0]->kunciAplikasi[$i]->id_kata_kunci == 0){
                                                                        echo '';
                                                                    }else{
                                                                        echo $proposal[0]->kunciAplikasi[$i]->kataKunciAplikasi->kata_kunci;
                                                                    }
                                                                    ?>
                                                                </td>
                                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="tblTeknologiLevel3" name="tblTeknologiLevel3">
                                                        ...
                                                        <?php
                                                            $index = 1;
                                                            $num = count($proposal[0]->kunciKolaborasi);
                                                        ?>
                                                        @for($i=0;$i<$num;$i++)
                                                            <tr>
                                                                <td>{{$index}}</td>
                                                                <td>{{$kunciKolaborasiLevel1[$i]->kata_kunci}}</td>
                                                                <td>
                                                                    <?php
                                                                    if ($proposal[0]->kunciKolaborasi[$i]->id_kata_kunci == 0){
                                                                        echo '';
                                                                    }else{
                                                                        echo $proposal[0]->kunciKolaborasi[$i]->kataKunciKolaborasi->kata_kunci;
                                                                    }
                                                                    ?>
                                                                </td>
                                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    ?>
                                                    <table class="table table-striped table-bordered table-hover" id="tblFile" name="tblFile">
                                                        <thead>
                                                        <tr>
                                                            <th>No</th>
                                                            <th>File</th>

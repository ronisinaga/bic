    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Proposal
                <small>Proposal sudah review</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Proposal Sudah Review</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Proposal Sudah Review Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Proposal Sudah Review</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($proposal as $item)
                                    <tr>
                                        ...
                                        <td><a href='<?php echo env('APP_URL'); ?>/admin/reviewer/proposal/{{$item->id}}/5/masuk'>{{$item->judul}}</a></td>
                                        <td>{{$item->statusProposal->status}}</td>
                                        <td width="250px">
                                            <a href="<?php echo env('APP_URL'); ?>/admin/adminproses/proposal/{{$item->id}}/0/masukanteknis" class="btn purple"><i class="fa fa-question-circle"></i> Masukan Teknis </a>
                                            <!--<a href="<?php echo env('APP_URL'); ?>/admin/adminproses/proposal/{{$item->id}}/pilihjuri" class="btn blue"><i class="fa fa-send"></i> Review </a>-->
                                            <a href="<?php echo env('APP_URL'); ?>/admin/adminproses/proposal/{{$item->id}}/review" class="btn blue"><i class="fa fa-send"></i> Review </a>
                                        </td>
                                    </tr>
                                    <?php $index++; ?>
                                @endforeach

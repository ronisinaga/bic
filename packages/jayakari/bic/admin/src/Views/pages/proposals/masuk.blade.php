            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Proposal Baru Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Proposal Baru</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($proposal as $item)
                                    <tr>
                                        ...
                                        <td><a href='<?php echo env('APP_URL'); ?>/admin/reviewer/proposal/{{$item->id}}/2/masuk'>{{$item->judul}}</a></td>
                                        <td>{{$item->statusProposal->status}}</td>
                                            ...
                                            if ($now-$start >= 3){
                                                ...
                                                echo '<td><a href="'.env('APP_URL').'/admin/reviewer/proposal/'.$item->id.'/sendNewEmail" class="btn blue"><i class="fa fa-send"></i> Kirim Pesan</a></td>';
                                            }
                                            ?>
                                    </tr>
                                    <?php $index++ ?>

    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Proposal
                <small>Proposal belum review</small>
            </h3>
            <div class="page-bar">
                <!--<ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Proposal Belum Review</span>
                    </li>
                </ul>-->
                <ul class="page-breadcrumb">
                    <li style="color: red">
                ...
                <!--<p style="text-align: justify">Tugas Reviewer adalah setiap saat mengusahakan STATUS BELUM REVIEW = 0. Artinya proposal sudah diteruskan untuk REVISI, DITOLAK, atau berstatus SUDAH REVIEW</p>-->
                <!--<div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Proposal Belum Review Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Proposal Belum Review</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($proposal as $item)
                                    <tr>
                                        ...
                                        <td><a href='<?php echo env('APP_URL'); ?>/admin/reviewer/proposal/{{$item->id}}/3/masuk'>{{$item->judul}}</a></td>
                                        <td>{{$item->statusProposal->status}}</td>
                                        <td>
                                            <?php
                                            if (($item->statusProposal->status == 'REVIEW')){
                                                echo '<a href="'.env('APP_URL').'/admin/reviewer/proposal/'.$item->id.'/review" class="btn blue"><i class="fa fa-send"></i> Review </a>';
                                            }
                                            ?>
                                        </td>
                                    </tr>

                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="tblChosenInovatorMember" name="tblChosenInovatorMember">
                                                        ...
                                                        @foreach($inovatormember as $item)
                                                            <tr>
                                                                ...
                                                                <td style="display: none">{{$item->id}}</td>
                                                                <td>{{$item->name}}</td>
                                                                <td style="display: none">{{$item->id_rsc}}</td>
                                                                <td>{{$item->rsc_name}}</td>
...
@section('footer_page')
    ...
    <script type="text/javascript">
        ...
        var abstrak = <?= json_encode($proposal[0]->abstrak); ?>;
        $('textarea#abstrak').val('<?php echo $proposal[0]->abstrak ?>');
        //$('textarea#abstrak').val(abstrak);
        var deskripsi = <?= json_encode($proposal[0]->deskripsi); ?>;
        $('textarea#deskripsi').val('<?php echo $proposal[0]->deskripsi; ?>');
        //$('textarea#deskripsi').val(deskripsi);
        var keunggulan_teknologi = <?= json_encode($proposal[0]->keunggulan_teknologi); ?>;
        $('textarea#keunggulan_teknologi').val('<?php echo $proposal[0]->keunggulan_teknologi; ?>');
        //$('textarea#keunggulan_teknologi').val(keunggulan_teknologi);
        var potensi_aplikasi = <?= json_encode($proposal[0]->potensi_aplikasi); ?>;
        $('textarea#potensi_aplikasi').val('<?php echo $proposal[0]->potensi_aplikasi; ?>');
        //$('textarea#potensi_aplikasi').val(potensi_aplikasi);

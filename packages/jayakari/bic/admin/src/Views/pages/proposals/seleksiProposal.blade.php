        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Proposal Seleksi</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Proposal Seleksi Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Proposal Seleksi</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($proposal as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if (($item->statusProposal->status == 'REVIEW') || (($item->statusProposal->status == 'SELEKSI'))){
                                                echo '<a href="'.env('APP_URL').'/admin/adminproses/proposal/'.$item->id.'/0/masukanteknis" class="btn purple"><i class="fa fa-question-circle"></i> Masukan Teknis </a>';
                                            }
                                            ?>
                                        </td>
                                    </tr>

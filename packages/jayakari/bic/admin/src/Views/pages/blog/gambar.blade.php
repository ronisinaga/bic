        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Gambar Blog</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Gambar Blog Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Gambar Blog</span>
                            </div>
                        </div>
                            ...
                            <form role="form">
                                <div class="form-body">
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="judul" name="judul" value="{{$blog->judul}}" disabled>
                                                    ...
                                                    <div class="mt-element-card mt-element-overlay">
                                                        ...
                                                        if ($num <= 1){
                                                            ...
                                                            for($i=1;$i<$num;$i=$i+6){
                                                                ...
                                                                echo '<img src="'.env('APP_URL').'/public/storage/blog/'.$blog->image[$i]->file300x300.'" />';
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/blog/scripts/gambar.js" type="text/javascript"></script>
@stop
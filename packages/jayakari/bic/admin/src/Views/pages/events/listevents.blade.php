            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> List Kegiatan Content
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="new_event" class="btn sbold green"> Tambah Kegiatan
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    <td> 1 </td>
                                    <td> <a href="<?php echo env('APP_URL'); ?>/admin/news/detailBerita">Ini nama kegiatan 1</a> </td>
                                    <td>
                                        27 September 2017
                                    </td>
                                    <td> 29 September 2017 </td>
                                    <td> Ini keterangan dari kegiatan 1 </td>
                                    <td>
                                        ...
                                        <button type="button" class="btn red" id="gambar" name="gambar">Gambar</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td> 2 </td>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/events/scripts/listevents.js" type="text/javascript"></script>

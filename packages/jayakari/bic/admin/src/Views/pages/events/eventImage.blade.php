    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Kegiatan
                <small>Tambah gambar-gambar kegiatan</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Tambah Gambar - Gambar Kegiatan</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Tambah Gambar-Gambar Kegiatan Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Tambah Gambar-Gambar Kegiatan</span>
                            </div>
                        </div>
                                ...
                                <div class="form-body">
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <select class="form-control" id="form_control_1">
                                            <option value=""></option>
                                            <option value="menu">Nama Kegiatan 1</option>
                                            <option value="reviewer">Nama Kegiatan 2</option>
                                            <option value="juri">Nama Kegiatan 3</option>
                                            <option value="juri">Nama Kegiatan 4</option>
                                        </select>

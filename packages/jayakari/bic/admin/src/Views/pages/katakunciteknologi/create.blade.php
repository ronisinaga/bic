...
@section('header_page')
    ...
    <link href="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/katakunciteknologi/css/create.css" rel="stylesheet" type="text/css" />
@stop
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Tambah Kata Kunci Teknologi</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Tambah Kata Kunci Teknologi Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Tambah Kata Kunci Teknologi</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form role="form">
                                <div class="form-body">
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        ...
                                        <select class="form-control" data-placeholder="Pilih tipe teknologi" id="selType" name="selType">
                                            ...
                                            @foreach($tipeteknologi as $item)
                                                <option value="{{$item->id}}">{{$item->kode}}({{$item->tipe_teknologi}})</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="level1" name="level1" style="">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="katakunciteknologi" name="katakunciteknologi">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/katakunciteknologi/scripts/create.js" type="text/javascript"></script>
@stop

            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                    <div class="dashboard-stat blue">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="<?php echo $baruNum; ?>">0</span>
                            </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <div class="dashboard-stat purple">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="<?php echo $revisiNum; ?>"></span> </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <div class="dashboard-stat red">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="<?php echo $ditolakNum ?>"></span> </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                    <div class="dashboard-stat green">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="<?php echo $belumreviewNum; ?>">0</span></div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                    <div class="dashboard-stat default">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="<?php echo $sudahreviewNum; ?>">0</span>
                            </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <div class="dashboard-stat yellow">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="<?php echo $seleksiNum; ?>"></span> </div>
                ...
                <!--<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <div class="dashboard-stat yellow">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="<?php echo $diterimaNum; ?>"></span> </div>

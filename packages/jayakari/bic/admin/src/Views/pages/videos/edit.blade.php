...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title"> Manajemen Videos
                <small>Edit Videos</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="icon-diamond"></i>
                        <a href="javascript:;">Manajemen Videos</a>
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Edit Videos Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Edit Videos</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form role="form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="keterangan" value="{{$videos[0]->keterangan}}">
                                        <label for="keterangan">Keterangan</label>
                                    </div>
                                    <div class="form-group">
                                        <label for="keterangan">Aktif</label>
                                        <select class="form-control" id="selAktif" name="selAktif">
                                            <option value="1" <?php $selected = $videos[0]->is_active==1?"selected":""; echo $selected; ?>>Ya</option>
                                            <option value="0" <?php $selected = $videos[0]->is_active==0?"selected":""; echo $selected; ?>>Tidak</option>
                                        </select>
                                    </div>
                                </div>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/videos/scripts/edit.js" type="text/javascript"></script>
@stop

            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Video Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Video</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($videos as $data)
                                    <tr>
                                        <td> {{$id}} </td>
                                        <td>{{$data->url_youtube}} </td>
                                        <td>
                                            {{$data->keterangan}}
                                        </td>
                                        <td>
                                            <a href="<?php echo env('APP_URL'); ?>/admin/videos/{{$data->id}}/edit" class="btn blue">
                                                <i class="fa fa-pencil"></i> Edit </a>
                                            <!--<a href="<?php echo env('APP_URL'); ?>/admin/videos/{{$data->id}}/delete" class="btn red">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/videos/scripts/index.js" type="text/javascript"></script>

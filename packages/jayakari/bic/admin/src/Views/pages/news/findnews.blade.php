            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Cari Berita Content
                            ...
                            <form role="form">
                                <div class="form-body">
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        ...
                                        <label for="form_control_1">Kategori Berita</label>
                            ...
                            <form role="form">
                                ...
                                <div class="form-body">
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        ...
                                        <tr>
                                            <td> 1 </td>
                                            <td> <a href="<?php echo env('APP_URL'); ?>/admin/news/detailBerita">Ini judul berita 1</a> </td>
                                            <td>
                                                Inovasi
                                            </td>
                                            <td> Sebagian isi dari berita yang ada. Jumlah karakternya ditentukan kemudian untuk ditampilkan </td>
                                        </tr>
                                        <tr>
                                            <td> 2 </td>
                                            <td> <a href="<?php echo env('APP_URL'); ?>/admin/news/detailBerita">Ini judul berita 1</a> </td>

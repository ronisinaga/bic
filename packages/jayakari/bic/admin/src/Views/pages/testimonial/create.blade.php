    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Testimonial
                <small>Tambah Testimonial</small>
            </h3>
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Tambah Testimonial Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Tambah Testimonial</span>
                            </div>
                        </div>
                            ...
                            <form role="form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="testimonial" name="testimonial" rows="5"></textarea>
                                    </div>
                                    <div class="form-group">
...
@section('footer_page')
    ...
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/testimonial/scripts/create.js" type="text/javascript"></script>
@stop

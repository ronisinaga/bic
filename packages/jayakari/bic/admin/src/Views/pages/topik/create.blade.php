...
@section('header_page')
    ...
    <link href="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/topik/css/create.css" rel="stylesheet" type="text/css" />
@stop
@section('content')
            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Tambah Bidang Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Tambah Bidang</span>
                            </div>
                        </div>
...
@section('footer_page')
    ...
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/topik/scripts/create.js" type="text/javascript"></script>
@stop

    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Inbox
                <small>Message dari inovator</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Message dari inovator</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Message dari inovator Content
                    ...
                    <form class="form-horizontal form-without-legend" role="form" action="<?php echo  env('APP_URL'); ?>/admin/home">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-offset-2 padding-left-0 padding-top-20">
                                <button type="button" class="btn btn-primary" id="review" name="review"><i class="fa fa-comment"></i> Review</button>
...
@section('footer_page')
    ...
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/emails/scripts/contentReview.js" type="text/javascript"></script>

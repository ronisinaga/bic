                    ...
                    <form class="form-horizontal form-without-legend" role="form" action="<?php echo  env('APP_URL'); ?>/admin/home">
                                ...
                                <label class="control-label">
                                    <?php
                                        ...
                                        for($i=0;$i<$num&&!$found;$i++){
                                            if ($receiver[$i]->id == $proposalMessage[0]->id_receiver){
                                                echo '<b>'.$receiver[$i]->fullname.'</b>';
                                                $found = true;
                                            }
                                        }
                                    ?>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-offset-2 padding-left-0 padding-top-20">
                                <button type="button" class="btn btn-primary" id="kembaliSent" name="kembaliSent"><i class="fa fa-arrow-circle-left"></i> Kembali</button>
                            </div>
                        </div>
                    </form>
                </div>

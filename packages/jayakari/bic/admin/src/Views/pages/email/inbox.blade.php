            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Inbox Content
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tbody>
                                @foreach($proposalMessage as $item)
                                    <tr>
                                        <td>Reviewer</td>
                                        <td>{{$receiver[0]->fullname}}</td>
                                        <?php $date = new DateTime($item->inserted_date); ?>
                                        <td>{{$date->format('d M Y H:i:s')}}</td>
                                        <td><a href="inbox/{{$item->id}}">{{$item->judul}}</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>

                        ...
                        <div class="portlet-body form">
                            <form role="form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="folder" name="folder" value="{{$buku->folder_inreview or ''}}">
...
@section('footer_page')
    ...
    <script type="text/javascript">
        ...
        var back = host+'/admin/buku/inreview';
        var save = host+'/admin/buku/inreview/folder/save';
    </script>

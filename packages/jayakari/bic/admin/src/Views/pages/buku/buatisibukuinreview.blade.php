...
@section('content')
                            ...
                            <form role="form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="judul_teknis_lengkap" name="judul_teknis_lengkap"></textarea>
                                        <span class="help-block">Harus diisi*</span>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="perspektif" name="perspektif"></textarea>
                                        <span class="help-block">Harus diisi*</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="menu">Keunggulan Inovasi</label>
                                        <textarea class="form-control" id="keunggulan_inovasi" name="keunggulan_inovasi"></textarea>
                                        <span class="help-block">Harus diisi*</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="menu">Potensi Aplikasi</label>
                                        <textarea class="form-control" id="potensi_aplikasi" name="potensi_aplikasi"></textarea>
                                        <span class="help-block">Harus diisi*</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="menu">Nama Inovator</label>
                                        <textarea class="form-control" id="inovator" name="inovator"></textarea>
                                        <span class="help-block">Harus diisi*</span>
                                    </div>
                                    <div class="form-group form-md-line-input form-md-floating-label">
                ...
                <div class="col-md-6 ">
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                <i class="icon-pin font-green"></i>
                                <span class="caption-subject bold uppercase">{{$proposal->id.'-'.$proposal->judul}}</span>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="popupConfirm"tabindex="-1" name="popupConfirm" role="dialog">
        <div class="modal-dialog">
            <form id="formUpload" name="formUpload">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title">Keluar dari halaman isi buku</h4>
                    </div>
                    <div class="modal-body">
                        <p>Apakah anda yakin ingin keluar dari halaman isi buku?</p>
                    </div><br>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="update">Iya & Update Buku</button>
                        <button type="button" class="btn btn-warning" id="noupdate">Iya & Tidak Update Buku</button>
                        <button type="button" class="btn btn-danger" data-dismiss="modal" id="batal">Batal</button>
                    </div>
                </div>
            </form>
        </div>
...
@section('footer_page')
    ...
    <script type="text/javascript">
        ...
        var save = '{{route('admin.buku.inreview.saveisibuku')}}';
        var back = '{{route('admin.buku.inreview.isi',['id'=>$buku->id])}}';
    </script>
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/buku/scripts/buatisibuku.js" type="text/javascript"></script>
@stop

...
@section('header_page')
    ...
    <link href="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/css/loading.css?t=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
...
@section('footer_page')
    ...
    <script type="text/javascript">
        ...
        var update = '{{route('admin.buku.updateisibuku')}}';
        var back = '{{route('admin.buku.isi',['id'=>$buku->id])}}';
    </script>
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/buku/scripts/editisibuku.js?t=<?php echo time(); ?>" type="text/javascript"></script>
@stop

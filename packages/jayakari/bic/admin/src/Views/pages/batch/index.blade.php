            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Batch Content
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="new" name="new" class="btn sbold green"> Tambah Batch
                            ...
                            <input type="hidden" id="total_listed" name="total_listed" value="{{$total_listed}}">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($batch as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo  env('APP_URL'); ?>/admin/batch/{{$data->id}}/edit" class="btn blue">
                                                <i class="fa fa-pencil"></i> Edit </a>
                                            <a href="<?php echo  env('APP_URL'); ?>/admin/batch/{{$data->id}}/delete" class="btn red">
...
@section('footer_page')
    ...
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/batch/scripts/index.js" type="text/javascript"></script>

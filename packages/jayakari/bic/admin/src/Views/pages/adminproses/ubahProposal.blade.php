                ...
                <div class="col-md-12 col-sm-12">
                    <form class="form-horizontal form-without-legend" role="form" action="<?php echo  env('APP_URL'); ?>/admin/home">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <label class="control-label"><b>[BIC] Ubah Status Proposal - </b>{{$proposal[0]->id}} - {{$proposal[0]->judul}}</label>
                        ...
                        <div class="form-group">
                            <label for="password" class="col-md-2 control-label">Status <span class="require">*</span></label>
                            <div class="col-md-10">
...
@section('footer_page')
    ...
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/adminproses/scripts/ubahProposal.js" type="text/javascript"></script>

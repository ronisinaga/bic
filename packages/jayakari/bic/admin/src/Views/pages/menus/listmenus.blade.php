            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> List Menu Content
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="new" class="btn sbold green"> Tambah Menu
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($menu as $data)
                                    <tr>
                                        <td> {{$id}} </td>
                                        <td> <i class="fa {{$data->icon}}"></i> {{$data->menu}} </td>
                                        <td><i class="fa {{$data->kategoriMenu["icon"]}}"></i> {{$data->kategoriMenu["kategori"]}}</td>
                                        <td>
                                            {{$data->url}}
                                        </td>
                                        <td>
                                            <a href="<?php echo env('APP_URL'); ?>/admin/menus/{{$data->id}}/edit" class="btn blue">
                                                <i class="fa fa-pencil"></i> Edit </a>
                                            <a href="<?php echo env('APP_URL'); ?>/admin/menus/{{$data->id}}/delete" class="btn red">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/menus/scripts/listmenus.js" type="text/javascript"></script>

        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Kirim pesan discontinued</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Kirim pesan discontinued Proposal Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Kirim Pesan Discontinued</span>
                            ...
                            <form role="form">
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        ?>
                                        <input type="text" id="status" name="status" value="{{$proposal[0]->status}}"/><br>
                                        <textarea class="ckeditor form-control" rows="6" id="sendDiscontinued" name="sendDiscontinued">{{$txtreview}}</textarea><br><br><br>
                                        <button class="btn blue" type="button" id="btnsendDiscontinued" name="btnsendDiscontinued"><i class="fa fa-send"></i> Kirim Pesan</button><hr>
                                        <div class="row">
                                            <div class="col-md-6">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/reviewers/scripts/sendDiscontinued.js" type="text/javascript"></script>
@stop
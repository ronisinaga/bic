                            ...
                            <form role="form">
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        $txtreview = "";
                                        if (count($review) <> 0){
                                            $txtsendEmail = $review[0]->isi;
                                        }
                                        ?>
                                        <textarea class="ckeditor form-control" rows="6" id="sendEmail" name="sendEmail">{{$txtreview}}</textarea><br><br><br>
                                        <button class="btn blue" type="button" id="btnsendEmail" name="btnsendEmail"><i class="fa fa-send"></i> Kirim Pesan</button><hr>
                                        <div class="row">
                                            <div class="col-md-6">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/reviewers/scripts/sendEmail.js?v=<?php echo time(); ?>" type="text/javascript"></script>
@stop
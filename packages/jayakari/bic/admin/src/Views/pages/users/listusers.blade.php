            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Pengguna Content
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="new" class="btn sbold green"> Tambah Pengguna
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                $num = count($item->userCategory);
                                                for($i=0;$i<$num;$i++){
                                                    if ($i == $num-1){
                                                        echo $item->userCategory[$i]->kategori;
                                                    }else{
                                                        echo $item->userCategory[$i]->kategori.',';
                                                    }
                                                }
                                        ...
                                        <td width="20%">
                                            <a href="<?php echo env('APP_URL'); ?>/admin/users/{{$item->id}}/edit" class="btn blue">
                                                <i class="fa fa-pencil"></i> Edit </a>
                                            <a href="<?php echo env('APP_URL'); ?>/admin/users/{{$item->id}}/delete" class="btn red">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/users/scripts/listusers.js" type="text/javascript"></script>

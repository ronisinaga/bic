    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen   Kategori Pengguna
                <small>Manajemen kategori pengguna</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>List Kategori Pengguna</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Kategori Pengguna Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Kategori Pengguna</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="new" class="btn sbold green"> Tambah Kategori Pengguna
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            $num = count($item->kategoriMenu);
                                            for($i=0;$i<$num;$i++){
                                                if ($i == $num-1){
                                                    echo $item->kategoriMenu[$i]->kategori;
                                                }else{
                                                    echo $item->kategoriMenu[$i]->kategori.', ';
                                                }
                                            }
                                    ...
                                    <td width="20%">
                                        <a href="<?php echo env('APP_URL'); ?>/admin/usergroup/{{$item->id}}/edit" class="btn blue">
                                            <i class="fa fa-pencil"></i> Edit </a>
                                        <a href="<?php echo env('APP_URL'); ?>/admin/usergroup/{{$item->id}}/delete" class="btn red">

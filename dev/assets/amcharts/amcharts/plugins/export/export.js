	...
	AmCharts[ "export" ] = function( chart, config ) {
		var _this = {
			...
			defaults: {
				...
				fileName: "amCharts",
				action: "download",
				path: ( ( chart.path || "" ) + "layouts/export/" ),
				formats: {
					JPG: {
						mimeType: "image/jpg",
						extension: "jpg",
			...
			/**
			 * Generates export menus; returns UL node
			 */
			createMenu: function( list, container ) {
				...
				_this.setup.menu.setAttribute( "class", _this.setup.chart.classNamePrefix + "-export-menus " + _this.setup.chart.classNamePrefix + "-export-menus-" + _this.config.position + " amExportButton" );
			...
			/**
			 * Initiate export menus; waits for chart container to place menus
			 */
			init: function() {

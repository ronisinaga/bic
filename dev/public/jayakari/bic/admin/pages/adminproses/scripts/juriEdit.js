...
var juri = {
    ...
    saveJuri : function(json){
        if (juri.valid()){
            $.ajax({
                method: 'POST',
                url: host+'/admin/adminproses/juri/'+$('#id').val()+'/edit',
                data: {
                    data: json
                },
                dataType: "json",
                ...
                success: function (response){
                    ...
                    if (response.status == "success"){
                        toastr["success"]('Data assign juri berhasil diupdate ke dalam basisdata','Sukses');
...
$('#btnSimpan').on('click',function(){
    var json = '{"sender":"bic","id":'+$('#id').val()+',"id_topik":'+$('#selTopik').val()+',"id_juri":'+$('#selJuri').val()+'}';
    juri.saveJuri(json);
});

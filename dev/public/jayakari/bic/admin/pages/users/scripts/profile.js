        ...
        toastr.options = {
            ...
            "onHidden": function() {
                if (profile.config.valid){
                    ...
                    profile.redirectToPage(host+'/admin/home/inovator');
                }
            },
            "showDuration": "300",
            "hideDuration": "1000",
                    ...
                    $.ajax({
                        ...
                        success: function (response){
                            if (response.status == "success"){
                                ...
                                toastr["success"]('Berhasil upload avatar inovator','Success');
...
$('#kirim').on('click',function(){
    var arr = {
        ...
        "nickname_origin":$("#nickname_origin").val(),
        "email":$("#email").val(),
        "jk":$("#selJK").val(),
        "hp":$("#hp").val(),
        "alamat":$("#alamat").val(),

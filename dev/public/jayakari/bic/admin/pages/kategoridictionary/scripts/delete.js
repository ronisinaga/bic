...
var kategoridictionary = {
    ...
    setup: function(){
        toastr.options = {
            ...
            "onclick": null,
            "onHidden": function() {
                //location.href = host+'/admin/kategoridictionary';
    ...
    save: function(json){
        $.ajax({
            method: 'POST',
            url: host+'/admin/kategoridictionary/'+$('#id').val()+'/delete',
            data: {
                data: json
            },
            dataType: "json",
            ...
            success: function (response){
                ...
                if (response.status == 'success'){
                    ...
                    toastr['success']("Sistem berhasil hapus data kategori dictionary "+$('#name').val(),"Success");
                }
            },
...
$('#btnHapus').on('click',function(){
    //kategoridictionary.redirectToPage(host+'/admin/kategoridictionary');
    var json= '{"sender":"bic","id":"'+$('#id').val()+'","kategoridictionary":"'+$("#name").val()+'"}';

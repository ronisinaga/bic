    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Status Proposal
                <small>Manajemen Status Proposal</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>List Status Proposal</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Status Proposal Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Status Proposal</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="new" name="new" class="btn sbold green"> Tambah Status Proposal
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                $id = 1;
                                ?>
                                @foreach($statusproposal as $data)
                                    <tr>
                                        <td> {{$id}} </td>
                                        <td> <i class="fa {{$data->icon}}"></i> {{$data->status}} </td>
                                        <td>
                                            {{$data->keterangan}}
                                        </td>
                                        <td>
                                            <a href="<?php echo env('APP_URL'); ?>/admin/statusproposal/{{$data->id}}/edit" class="btn blue">
                                                <i class="fa fa-pencil"></i> Edit </a>
                                            <a href="<?php echo env('APP_URL'); ?>/admin/statusproposal/{{$data->id}}/delete" class="btn red">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/statusproposal/scripts/index.js" type="text/javascript"></script>

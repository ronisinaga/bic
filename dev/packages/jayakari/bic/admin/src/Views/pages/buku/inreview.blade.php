                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($buku as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($activeCategory == 7){ ?>
                                            <a href="{{route('admin.buku.inreview.edit',['id'=>$data->id])}}" class="btn blue">
                                                <i class="fa fa-pencil"></i> Edit </a>
                                            <?php   } ?>
                                            <a href="{{route('admin.buku.inreview.folder',['id'=>$data->id])}}" class="btn yellow">
                                                <i class="fa fa-folder"></i> Folder </a>
                                            <a href="{{route('admin.buku.inreview.cover',['id'=>$data->id])}}" class="btn purple">
                                                <i class="fa fa-file-picture-o"></i> Cover </a>
                                            <a href="{{route('admin.buku.inreview.isi',['id'=>$data->id])}}" class="btn red">
...
@section('footer_page')
    ...
    <script type="text/javascript">
        ...
        var create = '{{route('admin.buku.inreview.create')}}';
        var back = '';
    </script>
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/buku/scripts/inreview.js" type="text/javascript"></script>

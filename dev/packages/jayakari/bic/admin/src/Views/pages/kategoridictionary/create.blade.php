...
@section('header_page')
    ...
    <link href="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/kategoridictionary/css/create.css" rel="stylesheet" type="text/css" />
@stop
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Kategori Dictionary
                <small>Tambah Kategori Dictionary</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Tambah Kategori Dictionary</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Tambah Kategori Dictionary Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Tambah Kategori Dictionary</span>
                            </div>
                        </div>
                            ...
                            <form role="form">
                                <div class="form-body">
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="kategoridictionary" name="kategoridictionary">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/kategoridictionary/scripts/create.js" type="text/javascript"></script>
@stop

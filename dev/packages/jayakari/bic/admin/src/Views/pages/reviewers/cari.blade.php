...
@section('header_page')
    ...
    <link href='{{url('public/vendors/bootstrap-datepicker/css/datepicker3.css')}}' rel='stylesheet'  type="text/css">
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="control-label col-md-3">Nomor Proposal Awal</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="nomorAwal" name="nomorAwal" class="form-control"/>
                                                </div>
                                            </div><br>
                                            <div class="row">
                                                <label class="control-label col-md-3">Nomor Proposal Akhir</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="nomorAkhir" name="nomorAkhir" class="form-control"/>
                                                </div>
                                            </div><br>
                                            <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-3 control-label" for="name">Tanggal Mulai</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                                                        </span>
                                                        <input type="text" data-plugin-datepicker class="form-control datepicker" id="start" name="start" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-3 control-label" for="name">Tanggal Akhir</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                                                        </span>
                                                        <input type="text" data-plugin-datepicker class="form-control datepicker" id="end" name="end" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div style="display: block" id="divResult" name="divResult">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="{{env("APP_URL")}}/public/storage/icon/excel.png" id="download" name="download"/>
                                    </div>
                                </div><br>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/assets/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/reviewers/scripts/cari.js" type="text/javascript"></script>

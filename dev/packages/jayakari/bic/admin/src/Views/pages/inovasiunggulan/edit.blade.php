    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Inovasi Unggulan
                <small>Edit Inovasi Unggulan</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Edit Inovasi Unggulan</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Edit Inovasi Unggulan Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Edit Inovasi Unggulan</span>
                            </div>
                        </div>
                            ...
                            <form role="form">
                                <div class="form-body">
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="tema" name="tema" value="{{$inovasiunggulan->tema}}">
                                        <input type="hidden" class="form-control" id="id" name="id" value="{{$inovasiunggulan->id}}">
                                        <label for="menu">Tema</label>
                                        <span class="help-block">Harus diisi*</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="keterangan">Penjelasan</label>
                                        <textarea class="form-control" id="keterangan" name="keterangan">{{$inovasiunggulan->keterangan}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="keterangan">Aktif</label>
                                        <select class="form-control" id="selAktif" name="selAktif">
                                            <option value="0" <?php $selected = $inovasiunggulan->is_active == 0?"selected":""; echo $selected; ?>>Tidak</option>
                                            <option value="1" <?php $selected = $inovasiunggulan->is_active == 1?"selected":""; echo $selected; ?>>Ya</option>
                                        </select>
                                    </div>
                                </div>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/inovasiunggulan/scripts/edit.js" type="text/javascript"></script>
@stop
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Kirim jawaban technical review</span>
                    </li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Kirim jawaban Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Kirim Jawaban</span>
                        ...
                        <div class="portlet-body form">
                            <form role="form">
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-cogs"></i>Jawaban Anda</div>&nbsp;&nbsp;&nbsp;
                                        <div class="tools">
                                            <a href="javascript:;" class="collapse"> </a>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <label class="control-label"><b>Isi Jawaban</b></label>
                                        <?php
                                        $txtreview = "";
                                        if (count($review) <> 0){
                                        ...
                                        ?>
                                        <textarea class="ckeditor form-control" rows="6" id="jawaban" name="jawaban">{{$txtreview}}</textarea><br><br><br>
                                        <button class="btn blue" type="button" id="btnSimpan" name="btnSimpan"><i class="fa fa-send"></i> Kirim Jawaban</button><hr>
                                        <div class="row">
                                            <div class="col-md-6">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/technicalreviewer/scripts/jawaban.js" type="text/javascript"></script>
@stop
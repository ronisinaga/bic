                                    ...
                                    <td>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="tblTeknologiLevel3" name="tblTeknologiLevel3">
                                            ...
                                            <tr>
                                                ...
                                                <td><b>{{$proposal->user->email}}</b></td>
                                                <td><b>{{$proposal->user->telp}}</b></td>
                                                <td><b>{{$proposal->instansi->nama_instansi}}</b></td>
                                            </tr>
                                            <?php
                                            $index = 1;
                                            ?>
...
@section('footer_page')
    ...
    <script type="text/javascript">
        ...
        var update = '{{route('admin.buku.inreview.updateisibuku')}}';
        var back = '{{route('admin.buku.inreview.isi',['id'=>$buku->id])}}';
    </script>
    <script src="<?php echo  env('APP_URL'); ?>/public/jayakari/bic/admin/pages/buku/scripts/editisibuku.js" type="text/javascript"></script>
@stop

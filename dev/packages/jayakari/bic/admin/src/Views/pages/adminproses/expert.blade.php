            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Expert Review Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Daftar Expert Review</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                $index = 1;
                                ?>
                                @foreach($technicalreviewer as $item)
                                    <tr>
                                        <td> {{$index}} </td>
                                        <td> {{$item->id}}</td>
                                        ...
                                        <td>
                                            <?php
                                            if (($item->status == 'REVIEW') || (($item->status == 'SELEKSI'))){
                                                echo '<a href="'.env('APP_URL').'/admin/adminproses/proposal/'.$item->id.'/0/masukanteknis" class="btn green"><i class="fa fa-plus"></i> Tambah </a>';
                                            }
                                            ?>
                                        </td>
                                        <td>
                                            <?php
                                            if (($item->status == 'REVIEW') || (($item->status == 'SELEKSI'))){
                                                echo '<a href="'.env('APP_URL').'/admin/adminproses/proposal/'.$item->id.'/'.$item->id_juri.'/masukanteknis" class="btn purple"><i class="fa fa-question-circle"></i> Update </a>';
                                            }
                                            ?>
                                        </td>
                                    </tr>

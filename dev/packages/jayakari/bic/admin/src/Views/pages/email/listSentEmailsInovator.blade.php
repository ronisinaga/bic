@extends('jayakari.bic.admin::layouts.inovator')
@section('header_page')
            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Proposal Content
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Proposal</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> Reviewer </td>
                                        <td>
                                            <a href="<?php echo  env('APP_URL'); ?>/admin/email/isiSentEmail"><b>Mohon Review - </b> Ini Judul Inovasi yang akan direview</a>
                                        </td>

                                                        ...
                                                        if ($num == 0){
                                                            ...
                                                            for($i=0;$i<$num;$i=$i+6){
                                                                ...
                                                                if ($num > $i+5){
                                                                    ...
                                                                    echo '<ul class="mt-info">';
                                                                    echo '<li>';
                                                                    echo '<a class="btn default download" href="'.route('inovator.pemenang.file.download',['id'=>$proposal->filePemenang[$i+5]->id]).'" value="'.$proposal->filePemenang[$i+5]->id.'" id="download" name="download"><i class="fa fa-download"></i></a>';
                                                                    echo '</li>';
                                                                    echo '<li>';
...
@section('footer_page')
    ...
    <script type="text/javascript">
        ...
        var save = '{{route('inovator.pemenang.file.update')}}';
        var back = '{{route('inovator.pemenang.file.edit',['id'=>$proposal->id])}}';
        var remove = '{{route('inovator.pemenang.file.remove')}}';
        var mainback = '{{route('inovator.pemenang.file')}}';
    </script>

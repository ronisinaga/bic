                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="portlet light profile-sidebar-portlet bordered">
                            ...
                            <div class="profile-usertitle">
                                ...
                                <div class="profile-usertitle-job"> Technical Reviewer </div>
                            </div>
                                            ...
                                            <div class="tab-pane active" id="tab_1_1">
                                                <form role="form" action="#">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" placeholder="Nama" id="fullname" name="fullname" class="form-control" value="{{$datauser[0]->fullname}}"/> </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="3" id="alamat" name="alamat" placeholder="Alamat Anda">{{$datauser[0]->alamat}}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">{{$labels["TAR"]}}: </label>
                                                        <label class="control-label">{{$datauser[0]->alasan}}</label>
                                                        <input type="hidden" class="form-control" id="alasan" name="alasan" value="{{$datauser[0]->alasan}}"></input>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/users/scripts/profileTechnicalReviewer.js" type="text/javascript"></script>

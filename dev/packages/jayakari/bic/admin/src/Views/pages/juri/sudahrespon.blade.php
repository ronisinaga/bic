    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Pendapat Teknis
                <small>Daftar pendapat teknis yang sudah direspon</small>
            </h3>
            <div class="page-bar">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/juri/scripts/sudahrespon.js" type="text/javascript"></script>

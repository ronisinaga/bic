    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> Manajemen Buku
                <small>Update Cover Banner</small>
            </h3>
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true"> Cover Banner Content
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                @if($buku->cover_final <> null)
                                                    <img src="{{url('public/jayakari/bic/regular/'.$buku->cover_final)}}" width="50%"/>
                                                @else
...
@section('footer_page')
    ...
    <script type="text/javascript">
        ...
        var save = host+'/admin/buku/final/cover/save';
    </script>

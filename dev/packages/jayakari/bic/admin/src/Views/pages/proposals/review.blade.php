                            ...
                            <form role="form">
                                ...
                                @if(count($proposalJuri) > 0)
                                    <div class="portlet box blue">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-cogs"></i>Masukan Dewan Juri</div>&nbsp;&nbsp;&nbsp;
                                            <div class="tools">
                                                <a href="javascript:;" class="collapse"></a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <table class="table table-striped table-bordered table-hover" id="tblHistory" name="tblHistory">
                                                        ...
                                                        for($i=$num-1;$i>=0;$i--){
                                                            echo '<tr>';
                                                            echo '<td>'.$index.'</td>';
                                                            echo '<td>'.$proposalJuri[$i]->batch.'</td>';
                                                            echo '<td>'.$proposalJuri[$i]->topikstr.'</td>';
                                                            echo '<td>'.$proposalJuri[$i]->juri->fullname.'</td>';
                                                            echo '<td>'.$proposalJuri[$i]->alasan.'</td>';
                                                            echo '</tr>';
                                                            $index++;
                                                        }
                                                        ?>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/proposals/scripts/review.js" type="text/javascript"></script>
@stop
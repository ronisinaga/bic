                            ...
                            <form role="form">
                                <div class="form-body">
                                    <div class="form-group" style="margin-right: 10px;">
                                        ...
                                        <select class="form-control" data-placeholder="Pilih kategori menu" id="selKategori" name="selKategori">
                                            <option value="" selected></option>
                                            @foreach($kategori as $item)
                                            <option value="{{$item->id}}">{{$item->kategori}}</option>
                                            @endforeach
                                        </select>
                                        <span class="help-block" style="color: red">Harus dipilih*</span>
                                    </div>
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="menu" name="menu">
                                        <label for="menu">Menu</label>
                                        <span class="help-block" style="color: red">Harus diisi*</span>
                                    </div>
                                    <div class="form-group" style="margin-right: 10px;">
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/menus/scripts/addmenu.js" type="text/javascript"></script>
@stop

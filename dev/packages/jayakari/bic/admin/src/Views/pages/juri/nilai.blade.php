                            ...
                            <form role="form">
                                ...
                                @if($proposal->isiBuku <> null)
                                    @if ($banner->folder_final <> null)
                                        <h3>Klik disini <i class="fa fa-hand-o-right"></i> <a href="http://bic.web.id/public/storage/flippdf/{{$buku->folder_final}}/index.html" target="_blank">{{$proposal->isiBuku->buku->judul}}. Lihat di halaman: <b>{{$proposal->isiBuku->page}}</b></a></h3></a>
                                    @elseif($banner->folder_inreview <> null)
                                        <h3>Klik disini <i class="fa fa-hand-0-right"></i> <a href="http://bic.web.id/public/storage/flippdf/{{$buku->folder_inreview}}/index.html" target="_blank"> {{$proposal->isiBuku->buku->judul}}. Lihat di halaman: <b>{{$proposal->isiBuku->page}}</b></a></h3></b></a>
                                    @endif
                                @endif

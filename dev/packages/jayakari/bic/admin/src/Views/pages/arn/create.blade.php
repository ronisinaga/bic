...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <!-- BEGIN SAMPLE FORM PORTLDT-->
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                <i class="icon-pin font-green"></i>
                                <span class="caption-subject bold uppercase"> Tambah ARN</span>
                            </div>
                        </div>
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/admin/pages/arn/scripts/create.js" type="text/javascript"></script>
@stop

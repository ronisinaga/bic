    ...
    <div class="main">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    @if(count($currbuku) > 0)
                        <input type="hidden" id="judul" name="judul" value="{{$currbuku[0]->judul}}">
                    @else
                        <input type="hidden" id="judul" name="judul" value="">
                    @endif
                    ...
                    @if(count($isibuku) > 0)
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            for($i=0;$i<$num;$i=$i+2){
                                ...
                                $strurl = $isibuku[$i]->judul_singkat;
                                $strurl = str_replace('+','~',$strurl);
                                $url = urlencode($strurl);
                                echo '<h4><a href="'.env('APP_URL').'/general/inreview/'.$url.'">'.trim($isibuku[$i]->judul_singkat).'</a></h4>';
                                echo '<h4><i><a href="'.env('APP_URL').'/general/inreview/'.$url.'">'.trim($isibuku[$i]->short_title).'</a></i></h4><hr>';
                                ...
                                echo '<p><b>Peringkat Inovasi:</b> '.$peringkatInovasi.'</p>';
                                ...
                                if ($number > 0){
                                    ...
                                    $files = explode('.',$isibuku[$i]->file[0]->file);
                                    switch ($files[1]){
                                        case 'pdf':
                                            echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/pdf.png" class="img-responsive">';
                                            break;
                                        case 'doc':
                                            echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/word.png" class="img-responsive">';
                                            break;
                                        case 'docx':
                                            echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/word.png" class="img-responsive">';
                                            break;
                                        case 'xls':
                                            echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/excel.png" class="img-responsive">';
                                            break;
                                        case 'xlsx':
                                            echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/excel.png" class="img-responsive">';
                                            break;
                                        case 'ppt':
                                            echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/powerpoint.png" class="img-responsive">';
                                            break;
                                        case 'pptx':
                                            echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/powerpoint.png" class="img-responsive">';
                                            break;
                                        default:
                                            echo '<img width="225" height="225" alt="" src="'.env('APP_URL').'/public/storage/'.$isibuku[$i]->file[0]->path.'" class="img-responsive">';
                                            break;
                                    }
                                    ...
                                    if ($number >= 2){
                                        ...
                                        echo '<div class="mix-inner">';
                                        //echo '<a data-rel="fancybox-button" title="Project Name" href="'.env('APP_URL').'/public/storage/'.$isibuku[$i+1]->file[0]->path.'" class="fancybox-button">';
                                        $files = explode('.',$isibuku[$i]->file[1]->file);
                                        switch ($files[1]){
                                            case 'pdf':
                                                echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/pdf.png" class="img-responsive">';
                                                break;
                                            ...
                                            case 'pptx':
                                                ...
                                                break;
                                            default:
                                                echo '<img width="225" height="225" alt="" src="'.env('APP_URL').'/public/storage/'.$isibuku[$i]->file[1]->path.'" class="img-responsive">';
                                                break;
                                        }
                                        echo '<div class="mix-details">';
                                ...
                                if ($num > $i+1){
                                    ...
                                    echo '<div class="col-md-12">';
                                    echo '<h4><a href="'.env('APP_URL').'/general/inreview/'.$isibuku[$i+1]->judul_singkat.'">'.$isibuku[$i+1]->judul_singkat.'</a></h4>';
                                    echo '<h4><i><a href="'.env('APP_URL').'/general/inreview/'.$isibuku[$i+1]->judul_singkat.'">'.$isibuku[$i+1]->short_title.'</a></i></h4><hr>';
                                    ...
                                    if ($number > 0){
                                        ...
                                        echo '<div class="mix-inner">';
                                        //echo '<a data-rel="fancybox-button" title="Project Name" href="'.env('APP_URL').'/public/storage/'.$isibuku[$i+1]->file[0]->path.'" class="fancybox-button">';
                                        $files = explode('.',$isibuku[$i+1]->file[0]->file);
                                        switch ($files[1]){
                                            case 'pdf':
                                                echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/pdf.png" class="img-responsive">';
                                                break;
                                            ...
                                            case 'pptx':
                                                ...
                                                break;
                                            default:
                                                echo '<img width="225" height="225" alt="" src="'.env('APP_URL').'/public/storage/'.$isibuku[$i+1]->file[0]->path.'" class="img-responsive">';
                                                break;
                                        }
                                        echo '<div class="mix-details">';
                                        ...
                                        if ($number >= 2){
                                            ...
                                            echo '<div class="mix-inner">';
                                            //echo '<a data-rel="fancybox-button" title="Project Name" href="'.env('APP_URL').'/public/storage/'.$isibuku[$i+1]->file[0]->path.'" class="fancybox-button">';
                                            $files = explode('.',$isibuku[$i+1]->file[1]->file);
                                            switch ($files[1]){
                                                case 'pdf':
                                                    echo '<img alt="" src="'.env('APP_URL').'/public/storage/buku/pdf.png" class="img-responsive">';
                                                    break;
                                                ...
                                                case 'pptx':
                                                    ...
                                                    break;
                                                default:
                                                    echo '<img width="225" height="225" alt="" src="'.env('APP_URL').'/public/storage/'.$isibuku[$i+1]->file[1]->path.'" class="img-responsive">';
                                                    break;
                                            }
                                            echo '<div class="mix-details">';
...
@section('footer_page')
    ...
    <script src="<?php echo env('APP_URL'); ?>/public/jayakari/bic/regular/pages/buku/scripts/index.js" type="text/javascript"></script>
@stop